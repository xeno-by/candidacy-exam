...
\frametitle<4>{Quasiquote}
\frametitle<5>{Unquote}
\begin{semiverbatim}
...
\visible<3->{(defmacro aif args}
  \visible<4->{     \alert{`}(let*            ((temp \only<4>{...........}\only<5->{\alert{,(car args)}})}
                          \visible<4->{(it  temp))}
          \visible<4->{(if  temp}
             \visible<4->{\only<4>{............}\only<5->{\alert{,(cadr args)}}}
             \visible<4->{\only<4>{............}\only<5->{\alert{,(caddr args)}})))}
