...
\visible<2->{(defmacro aif args}
  \visible<4->{\alert<4>{(list }}\only<4->{\alert<4>{'}}\only<3>{(}\visible<3->{let }\visible<4->{\alert<4>{(list (list }}\only<4->{\alert<4>{'}}\only<3>{(}\visible<3->{it \text{\color{red}{(car args)}}}\only<3>{)}\visible<4->{)\alert<4>{)}}
    \visible<4->{\alert<4>{(list }}\only<4->{\alert<4>{'}}\only<3>{(}\visible<3->{if }\only<4->{\alert<4>{'}}\only<3>{(}\visible<3->{it}
            \visible<3->{\text{\color{purple}{(cadr args)}}}
            \visible<3->{\text{\color{teal}{(caddr args)}}}\only<4->{))\alert<4>{)}}\only<3>{))}
