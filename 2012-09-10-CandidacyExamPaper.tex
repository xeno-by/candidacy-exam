...
unquoting outside quasiquotes - either with \small \texttt{\$}\normalsize, the \emph{splice} operator that unquotes expressions, or with \small \texttt{splice}\normalsize,
another splice operator that unquotes declarations.

The snippet below illustrates the introduced concepts.
