...
As simple as this code can be, it is also incorrect.
...
At times though it is necessary to have the scopes of macro definition and macro call site melded.
...
that solves the \texttt{abort} problem in a fully hygienic way (i.e. without introducing
