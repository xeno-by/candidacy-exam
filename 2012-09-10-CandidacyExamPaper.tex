...
at macro use site. An curious fact is that Template Haskell also provides cross-stage persistence for
...
In this setting quasiquotes are mechanically translated into calls to the constructors wrapped in
