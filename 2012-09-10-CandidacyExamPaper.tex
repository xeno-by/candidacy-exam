...
We implemented a macro system \cite{burmako12} for the Scala programming language \cite{odersky10}
...
when untypeable templates or pattern matching are involved.
