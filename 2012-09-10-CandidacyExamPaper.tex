...
The paper is organized as follows. First we introduce the background by following the evolution
of macros and outlining typical pitfalls. Then we survey
macro systems in Template Haskell \cite{sheard02}, Nemerle \cite{skalski04} and Racket \cite{barzilay11}
and their approaches to containing the problems. Finally we summarize our findings
and propose directions for research.
