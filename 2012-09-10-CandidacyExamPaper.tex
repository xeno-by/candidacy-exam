...
the more sophisticated one is inadvertent collision of lexical scopes.
...
for quasiquotes and automatically alpha-renames introduced binders \cite{sheard02}. It is
...
as well as mechanisms for manual control.

Typechecking algorithms that catch errors in meta-programs are pioneered by MetaML
