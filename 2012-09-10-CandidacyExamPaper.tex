...
the color of normal code, that gets assigned to the binders it introduces. After the program
is fully expanded Nemerle resolves bindings, i.e. for every bindee the compiler looks for
a nearest preceding binder with the same color. If there's no such binder, the name is looked up
