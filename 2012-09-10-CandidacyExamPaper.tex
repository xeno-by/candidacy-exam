...
\usepackage[noadjust, sort, nocompress]{cite}
...
A significant body of recent research has been done on mechanisms to extend language grammars\
(\cite{allen09, erdweg11, kats10} to name only a few).
This paper however focuses on preventing macros from expanding into invalid code.
...
\bibitem{kats10}
L.~C.~L.~Kats and E.~Visser.
The Spoofax language workbench: Rules for declarative specification of languages and IDEs.
Object-Oriented Programming, Systems, Languages, and Applications, 2010.
